...
export default function DashboardServices() {
  ...
  const getStatusBadge = (status: string | null) => {
    switch (status) {
      case "approved":
        return <Badge className="bg-green-100 text-green-700 hover:bg-green-100 dark:bg-green-900/30 dark:text-green-400">Approved</Badge>;
      case "pending":
        return <Badge className="bg-yellow-100 text-yellow-700 hover:bg-yellow-100 dark:bg-yellow-900/30 dark:text-yellow-400">Pending</Badge>;
      case "rejected":
        return <Badge className="bg-red-100 text-red-700 hover:bg-red-100 dark:bg-red-900/30 dark:text-red-400">Rejected</Badge>;
      default:
    ...
    return (
      <DashboardLayout title="My Services" description="Manage your service listings">
        <EmptyState
          ...
          description="Please create a company profile first to manage services."
    ...
    <DashboardLayout title="My Services" description="Manage your service listings">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Start listing your services to reach more customers."
          actionLabel="Add Your First Service"
          actionHref="/dashboard/services/add"
        />
      )}
    </DashboardLayout>
  );
